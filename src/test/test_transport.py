...
class TransportTest(unittest.TestCase):
    ...
    def test_multiple_particles(self):
        ...
        for x in range(3):
            ...
            for y in range(len(particle.get_locations())):
                p_proj_lats.append(particle.get_locations()[y].get_latitude())
                p_proj_lons.append(particle.get_locations()[y].get_longitude())
                p_proj_depths.append(particle.get_locations()[y].get_depth())
